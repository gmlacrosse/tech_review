    ...
    public class CreateAstronautDutyTests
    {
        ...
        public async Task CreateAstronautDutyHandler_NoError()
        {
            ...
            using (var context = new StargateContext(_options))
            {
                ...
                var param = new CreateAstronautDuty() { Name = "Unit TesterA", Rank = "R1", DutyTitle = "Commander", DutyStartDate = new DateTime(2025, 1, 7) };
        ...
        public async Task CreateAstronautDutyPreProcessor_OverlapInDuties()
        {
            ...
            {
                context.People.Add(new Person { Id = 1, Name = "Unit TesterA" });
                context.AstronautDuties.Add(new AstronautDuty { Id = 1, PersonId = 1, DutyStartDate = new DateTime(2025, 1, 7), DutyTitle = "Commander", Rank = "R1" });
                await context.SaveChangesAsync();
            }
        ...
        public async Task CreateAstronautDutyPreProcessor_Retired()
        {
            using (var context = new StargateContext(_options))
            {
                ...
                context.AstronautDuties.Add(new AstronautDuty { Id = 1, PersonId = 1, DutyStartDate = new DateTime(2025, 1, 7), DutyTitle = "RETIRED", Rank = "R1" });
                await context.SaveChangesAsync();
            }
