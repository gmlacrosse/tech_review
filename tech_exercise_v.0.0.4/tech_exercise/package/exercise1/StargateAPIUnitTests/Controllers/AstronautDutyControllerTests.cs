...
namespace StargateAPI.Controllers.Tests
{
    [TestClass]
    public class AstronautDutyControllerTests
    {
        ...
        public async Task GetAstronautDutiesByName_NoError()
        {
            ...
            {
                Person = new PersonAstronaut { PersonId = 1, Name = "Tom" },
            ...
            var response = await _astronautDutyController.GetAstronautDutiesByName("Tom") as ObjectResult;
