...
namespace StargateAPI.Business.Commands
{
    ...
    public class CreateAstronautDutyPreProcessor : IRequestPreProcessor<CreateAstronautDuty>
    {
        ...
        public Task Process(CreateAstronautDuty request, CancellationToken cancellationToken)
        {
            ...
            var versifyNotRetired = _context.AstronautDetails.FirstOrDefault(z => z.PersonId == person.Id && z.CurrentDutyTitle == "RETIRED");

            if (versifyNotRetired is not null) throw new BadHttpRequestException($"{request.Name} is retired");
